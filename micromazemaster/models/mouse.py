...
class Mouse:
    def __init__(self, x, y, orientation, maze):
        ...
        self.TOFSensorLeft = TOFSensor(self.position[0]*cell_size, self.position[1]*cell_size, (self.orientation.value-1) * 90 + offset_angel)
        self.TOFSensorCenter = TOFSensor(self.position[0]*cell_size, self.position[1]*cell_size, (self.orientation.value-1) * 90)
        self.TOFSensorRight = TOFSensor(self.position[0]*cell_size, self.position[1]*cell_size, (self.orientation.value-1) * 90 - offset_angel)
